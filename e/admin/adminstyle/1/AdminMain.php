...
.flyoutMenu TD.flyoutLink {
	BORDER-RIGHT: #C9F1FF 1px solid;
	BORDER-TOP: #C9F1FF 1px solid;
	BORDER-LEFT: #C9F1FF 1px solid;
	CURSOR: hand;
	PADDING-TOP: 1px;
...
.flyoutMenu1 TD.flyoutLink1 {
	BORDER-RIGHT: #fbf9f9 1px solid;
	BORDER-TOP: #fbf9f9 1px solid;
	BORDER-LEFT: #fbf9f9 1px solid;
	CURSOR: hand;
	PADDING-TOP: 1px;
	BORDER-BOTTOM: #fbf9f9 1px solid
}
</STYLE>
<SCRIPT>
...
<TABLE width="100%" height="100%" border=0 cellpadding="0" cellSpacing=0>
                ...
                <TBODY>
                  <TR align=middle>
                    ...
                    <TD width=60 onMouseOut="if(document.menuform.onclickmenu.value!='dotoolmenu'){this.style.backgroundColor='';}" onMouseOver="if(document.menuform.onclickmenu.value!='dotoolmenu'){this.style.backgroundColor='#8CBDEF';}" onClick="DoOnclickMenu('dotoolmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=tool');" style="CURSOR: hand" id="dotoolmenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                          <td height="20"><div align="center"><font color="#FFFFFF"><strong>插件</strong></font></div></td>
                        </tr>
                      </table></TD>
                    <TD width=60 onMouseOut="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='';}" onMouseOver="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='#8CBDEF';}" onClick="DoOnclickMenu('doshopmenu');window.open('openpage/AdminPage.php?leftfile=<?=urlencode('../ShopSys/pageleft.php')?>&mainfile=<?=urlencode('../other/OtherMain.php')?>&title=<?=urlencode('商城系统管理')?>','AdminShopSys','');" style="CURSOR: hand;<?=$showshopmenu?'':'display:none'?>" id="doshopmenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                          <td height="20"><div align="center"><font color="#FFFFFF"><strong>商城</strong></font></div></td>
                        </tr>
                      </table></TD>
                    <TD width=60 onMouseOut="if(document.menuform.onclickmenu.value!='doothermenu'){this.style.backgroundColor='';}" onMouseOver="if(document.menuform.onclickmenu.value!='doothermenu'){this.style.backgroundColor='#8CBDEF';}" onClick="DoOnclickMenu('doothermenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=other');" style="CURSOR: hand" id="doothermenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                          <td height="20"><div align="center"><font color="#FFFFFF"><strong>其他</strong></font></div></td>
                        </tr>
                      </table></TD>
                    <TD width=60 onMouseOut="if(document.menuform.onclickmenu.value!='doextmenu'){this.style.backgroundColor='';}" onMouseOver="if(document.menuform.onclickmenu.value!='doextmenu'){this.style.backgroundColor='#8CBDEF';}" onClick="DoOnclickMenu('doextmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=extend');" style="CURSOR:hand;<?=$showextmenu?'':'display:none'?>" id="doextmenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                          <td height="20"><div align="center"><font color="#FFFFFF"><strong>扩展</strong></font></div></td>
                        </tr>
                      </table></TD>
                    <TD width=60 onMouseOut="if(document.menuform.onclickmenu.value!='dofastmenu'){this.style.backgroundColor='';}" onMouseOver="if(document.menuform.onclickmenu.value!='dofastmenu'){this.style.backgroundColor='#8CBDEF';}" onClick="DoOnclickMenu('dofastmenu');JumpToLeftMenu('adminstyle/1/left.php?ecms=fastmenu');" style="CURSOR:hand;<?=$showfastmenu?'':'display:none'?>" id="dofastmenu"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                          <td height="20"><div align="center"><font color="#FFFFFF"><strong>常用</strong></font></div></td>
                        </tr>
                      </table></TD>
                    <TD width="301"><div align="right"><font color="#ffffff">用户：<a href="user/EditPassword.php" target="main"><font color="#ffffff"><b>
                        <?=$loginin?>
                        </b></font></a>&nbsp;&nbsp;&nbsp;[<a href="#ecms" onClick="if(confirm('确认要退出?')){JumpToMain('ecmsadmin.php?enews=exit');}"><font color="#ffffff">退出</font></a>]&nbsp;&nbsp;</font></div></TD>
                  </TR>
                </TBODY>
              </TABLE></TD>
          </TR>
    ...
    <td height="22"><TABLE width="100%" height="22" border=0 cellpadding="0" cellSpacing=0>
        <TBODY>
          <TR>
            ...
            <TD width="99%" height="27"><TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle>
  ...
  <tr>
    <td height="100%" bgcolor="#ffffff"><TABLE width="100%" height="100%" cellpadding="0" cellSpacing=0 border=0 borderColor="#ff0000">
        <TBODY>
          <TR>
            <TD width="123" valign="top" bgcolor="#C9F1FF"><IFRAME frameBorder="0" id="dorepage" name="dorepage" scrolling="no" src="DoTimeRepage.php" style="HEIGHT:0;VISIBILITY:inherit;WIDTH:0;Z-INDEX:1"></IFRAME></TD>
            <TD noWrap id="frmTitle"><IFRAME frameBorder="0" id="left" name="left" scrolling="auto" src="ListEnews.php" style="HEIGHT:100%;VISIBILITY:inherit;WIDTH:200px;Z-INDEX:2"></IFRAME></TD>
            <TD><TABLE border=0 cellPadding=0 cellSpacing=0 height="100%" bgcolor="#C9F1FF">
                <TBODY>
                  <tr>
                    <TD onClick="switchSysBar()" style="HEIGHT:100%;"><font style="COLOR:666666;CURSOR:hand;FONT-FAMILY:Webdings;FONT-SIZE:9pt;"> <SPAN id="switchPoint" title="打开/关闭左边导航栏">3</SPAN></font>
                </TBODY>
              </TABLE></TD>
            <TD width="100%"><TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" align="right" border=0>
                <TBODY>
                  <TR>
                    <TD align=right><IFRAME id="main" name="main" style="WIDTH: 100%; HEIGHT: 100%" src="main.php" frameBorder=0></IFRAME></TD>
                  </TR>
                </TBODY>
              </TABLE></TD>
          </TR>
